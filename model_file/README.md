...
| 5. 라벨 또는 클래스 정의 | - 탐지 대상: 알약<br>  - 클래스 정보: [pill](./yolov8n_detect/dataset.yaml)         | 
| 6. 예시 데이터 및 결과  | <img src="./yolov8n_detect/val_bacth0_pred.jpg" width="200">  <img src="./yolov8n_detect/val_bacth1_pred.jpg" width="200">     | 
